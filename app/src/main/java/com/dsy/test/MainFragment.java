...
public class MainFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.go_tablelayout).setOnClickListener(this);
        view.findViewById(R.id.go_viewpager_for_pageapater).setOnClickListener(this);
        view.findViewById(R.id.go_achartengine_example).setOnClickListener(this);
